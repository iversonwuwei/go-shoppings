...
func main() {
	...
	smsClient := smsgateway.NewClient()
	authSvc := service.NewAuthService(adminRepo, memberRepo, tenantRepo, jwtMgr, rdb, platformWxApp, smsRepo, smsClient, cfg.SMS.AliyunSignName, cfg.App.Env)
