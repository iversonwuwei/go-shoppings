...
const (
	CouponReceiveLimitLimited   = "limited"
	CouponReceiveLimitUnlimited = "unlimited"
)
...
type Coupon struct {
	...
	ReceiveLimitType string           `gorm:"size:20;not null;default:'limited'" json:"receive_limit_type"`
	...
	UseLimit         int              `gorm:"not null;default:1" json:"use_limit"`
